...
exports.ChainDefinition = class ChainDefinition extends antelope.Struct {
    static from(data) {
        return super.from({
            ...data,
...
__decorate([
    antelope.Struct.field('checksum256')
], exports.ChainDefinition.prototype, "id", void 0);
__decorate([
    antelope.Struct.field('string')
], exports.ChainDefinition.prototype, "url", void 0);
__decorate([
    antelope.Struct.field(exports.Logo, { optional: true })
], exports.ChainDefinition.prototype, "logo", void 0);
__decorate([
    antelope.Struct.field(exports.ExplorerDefinition, { optional: true })
], exports.ChainDefinition.prototype, "explorer", void 0);
exports.ChainDefinition = __decorate([
    antelope.Struct.type('chain_definition')
...
const Chains = {
    EOS: exports.ChainDefinition.from({
    ...
    FIO: exports.ChainDefinition.from({
    ...
    FIOTestnet: exports.ChainDefinition.from({
    ...
    TelosTestnet: exports.ChainDefinition.from({
        id: '1eaa0824707c8c16bd25145493bf062aecddfeb56c736f6ba6397f3195f33c9f',
        url: 'https://telos.greymass.com',
    }),
    WAX: exports.ChainDefinition.from({
