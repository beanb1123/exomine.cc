import { BrowserLocalStorage, Struct, Name, PublicKey, Weight, UInt32, PermissionLevel, AbstractUserInterface, cancelable, Canceled } from '@wharfkit/session';
...
const translations = {
    ...
    'zh-Hans': { ...languages, ...zh_hans },
    'zh-Hant': { ...languages, ...zh_hant },
};
const config = {
    initLocale: 'en',
    translations,
